...
<?php include 'config/SYD_Class.php';
 ...
 ?>
<body
	class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white blue-sidebar-color logo-blue">
	<div class="page-wrapper">
		...
		<div class="page-header navbar navbar-fixed-top">
			<div class="page-header-inner ">
				...
				<div class="page-logo">
					<a href="index.html">
						<!-- <img alt="" src="assets/img/plus.png"> -->
						<span class="logo-default" style="font-size:25px;font-weight: bold;font-family: Algerian;">Deeq Hospital</span> </a>
				</div>
				<!-- logo end -->
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
								...
								<img alt="" class="img-circle " src="assets/img/deeq.jfif" />
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2023 &copy;  Deeq Hospital Management System 
				<!-- <a href="mailto:deeqkilled@gmail.com" target="_top" class="makerCss">Deeq Theme</a> -->
			</div>
